...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        RandomAccessFile raf = new RandomAccessFile("banco.bin", "rw"); // Cria o arquivo binario
        String bancoStr = Core.stringify(raf); // Converte o arquivo binario para string

        // Objetos secundarios
        listaInvertida lista = new listaInvertida();
        BoyerMoore bm;

        int huffmanVersao = 1; // versao atual do huffman
        Huffman huffman = new Huffman(huffmanVersao, bancoStr);
        ...
        while (!sair) {
            ...
            switch (opcao) {
                ...
                case 9:
                    ...
                    System.out.println();
                    System.out.println("____________________________________________"); // formatacao
                    System.out.println("Padrao a ser procurado: " + input);
                    System.out.println();
                    
                    // KMP
                    System.out.println("KMP: ");
                    //sysout: numero de instancias encontradas
                    //sysout: posicao da primeira instancia
                    //sysout: total de operacoes realizadas
                    //sysout: tempo de execucao

                    // Boyer-Moore
                    System.out.println("BOYER-MOORE: ");
                    bm = new BoyerMoore(input);
                    bm.findPadrao(bancoStr);
