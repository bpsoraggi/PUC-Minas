...
class Lista {
    ...
    public boolean pesqSeq(String x) {
        boolean resp = false;

        for (int i = 0; i < n; i++) {
            if (array[i].getName().compareTo(x) == 0) {
                resp = true;
                count++;
            } else {
                count++;
...
public class TP02Q03 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            if (nomeArquivo.compareTo("FIM") == 0) { // Se o nome do arquivo for 'FIM' da break
                break;
            }
            Games novoGames = new Games(); // Cria um novo objeto Games
        ...
        while (true) {
            if (chaveBusca.compareTo("FIM") == 0) { // Se o nome do arquivo for 'FIM' da break
                break;
            }
            if (listGames.pesqSeq(chaveBusca) == true) {
                MyIO.println("SIM");
            } else {
                MyIO.println("NAO");
            }
