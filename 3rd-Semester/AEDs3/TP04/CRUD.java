...
public class CRUD {
    ...
    public void convertToBin(Netflix netflix) {
        ...
        int i = 0; // contador de linhas para a barra de progresso
        ...
        try {
            if (raf.length() == 0) { // se o arquivo estiver vazio, cria o binario
                try {
                    ...
                    while (line != null) {
                        ...
                        barra.atualizar(i, 8807); // atualiza a barra de progresso
                        i++;
                    }
                    ...
                    System.out.println();
                    System.out.println("Erro ao iniciar o arquivo binario: " + e.getMessage());
                    e.printStackTrace();
                }
            }
            ...
            System.out.println();
                    System.out.println("Erro ao iniciar arquivos: " + e.getMessage());
                    e.printStackTrace();
        }
    }
