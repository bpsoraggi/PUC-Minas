...
public class CRUD {
    ...
    public void setHashPGlobal(int hashPGlobal) {this.hashPGlobal = hashPGlobal;}

    public int getHashQtdBuckets() {return hashQtdBuckets;}

    public void setHashQtdBuckets(int hashQtdBuckets) {this.hashQtdBuckets = hashQtdBuckets;}

    public long getArvoreRaiz() {return arvoreRaiz;}

    public void setArvoreRaiz(long arvoreRaiz) {this.arvoreRaiz = arvoreRaiz;}

    public int getArvoreQtdPgs() {return arvoreQtdPgs;}

    public void setArvoreQtdPgs(int arvoreQtdPgs) {this.arvoreQtdPgs = arvoreQtdPgs;}
                ...
                try {
                    try {
                        br = new BufferedReader(
                                new InputStreamReader(new FileInputStream("netflixBD.csv"), "iso-8859-1"));
                    } catch (Exception e) {
                        try {
                            br = new BufferedReader(
                                    new InputStreamReader(new FileInputStream("netflixBD.csv"), "utf-8"));
                        } catch (Exception e2) {
    ...
    public void getArvoreInfo() {
        setArvoreRaiz(arvoreB.readEndRaiz()); // le o endereco da raiz
        setArvoreQtdPgs(arvoreB.readQtdPaginas()); // le a quantidade de paginas
    }
